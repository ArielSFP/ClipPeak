...
def main():
    ...
    parser.add_argument("--task", type=str, default="transcribe", choices=["transcribe","translate"], help="speech recognition or translation")
    parser.add_argument("--language", type=str, default="auto",
                        choices=["auto","af","am","ar","as","az","ba","be","bg","bn","bo","br","bs","ca","cs","cy","da","de","el","en","es","et","eu","fa","fi","fo","fr","gl","gu","ha","haw","he","hi","hr","ht","hu","hy","id","is","it","ja","jw","ka","kk","km","kn","ko","la","lb","ln","lo","lt","lv","mg","mi","mk","ml","mn","mr","ms","mt","my","ne","nl","nn","no","oc","pa","pl","ps","pt","ro","ru","sa","sd","si","sk","sl","sn","so","sq","sr","su","sv","sw","ta","te","tg","th","tk","tl","tr","tt","uk","ur","uz","vi","yi","yo","zh"],
                        help="Origin language; if unset ('auto'), it is detected automatically.")
    ...
    for path, srt_path in subtitles.items():
        ...
        style = (
            "Alignment=2,MarginV=40,MarginL=55,MarginR=55,"
            "Fontname=Noto Sans,Fontsize=11,PrimaryColour=&H00d7ff,"
        ...
        cmd = (
            ffmpeg
            .input(path)
            .filter('subtitles', srt_path, force_style=style)
            .output(out_path, vcodec='libx264', acodec='copy', preset='medium', crf=23)
        )
        print("FFmpeg command:", " ".join(cmd.get_args()))
        cmd.run(quiet=False, overwrite_output=True)
